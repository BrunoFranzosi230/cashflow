...
type Conta = ContaFormData & {
  id: string;
  status: 'Aberto' | 'Recebido' | 'Pendente'; // ATUALIZADO
};
    ...
    const handleSave = (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEditMode) {
                ...
                // Mantém o status original ao editar (ex: "Recebido" ou "Pendente")
                ...
                const novaConta: Conta = {
                    ...
                    status: 'Aberto' // 2. Define o status padrão
                };
            ...
            <aside style={styles.sidebar}>
                ...
                <nav style={styles.nav}>
                    <ul style={styles.navList}>
                        ...
                        <li style={{...styles.navItem, ...styles.navItemActive}}><Link to="/contas-a-receber" style={styles.navLink}>Contas a receber</Link></li>
